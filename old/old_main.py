...
class App(Tk):
    ...
    def open_all_workers(self):
        self.allWorkersTab = AllWorkers(self.notebook)

    def open_all_units(self):
        self.allUnitsTab = AllUnits(self.notebook)

    def open_all_position(self):
        self.allPositionTab = AllPositions(self.notebook)
...
class FullWorkerInfo:
    ...
    def close_tab(self):
        ...
        self.worker.name_text.insert(END, f"{info[0]} {info[1]} {info[2]}")
